...
In the server folder, create a .env file and set the necessary environment variables:
...
You may need to replace MONGO_URI with your actual MongoDB connection string if you are using a cloud service and JWT_SECRET of your own
...
The backend should now be running on http://localhost:8000 and the frontend should be running on http://localhost:3000.
